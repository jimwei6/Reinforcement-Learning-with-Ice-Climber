...
# python ./train_dqn.py --agent DQN --dir ./DQN/rewards4/lr1e-3 --lr 0.001 --reward SPARSE --episodes 2000 --memory 25000 --batch 256 --decay 40000 --save-video-episode 100 --start-learning 1024
